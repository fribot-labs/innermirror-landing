...
export function createMissingReflectionAction({
  hasGitHubSnapshot,
  recentCommitCount,
  recentPullRequestCount,
  reflectionCount,
}: RuntimeNextActionRuleParams): RuntimeNextAction | null {
...
export function createMissingGitHubContextAction({
  hasRepository,
  hasGitHubSnapshot,
  reflectionCount,
}: RuntimeNextActionRuleParams): RuntimeNextAction | null {
...
export function createRecommendedFocusAction({
  currentFocus,
  recommendedFocus,
}: RuntimeNextActionRuleParams): RuntimeNextAction | null {
...
export function createAdaptiveCoachingAction({
  adaptiveCoaching,
}: RuntimeNextActionRuleParams): RuntimeNextAction | null {
...
export function createNextQuestionAction({
  nextQuestion,
}: RuntimeNextActionRuleParams): RuntimeNextAction | null {
...
export function createContinuityAction({
  hasRepository,
  connectedEventCount,
}: RuntimeNextActionRuleParams): RuntimeNextAction | null {
...
}: RuntimeNextActionRuleParams): RuntimeNextAction {
  if (
    hasReflectionDraft &&
    hasRepository
  ) {
