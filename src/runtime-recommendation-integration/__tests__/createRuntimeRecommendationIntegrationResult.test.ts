...
describe(
  ...
  () => {
    it(
      "returns complete when all active Integration sources are available",
      () => {
        const result =
          createRuntimeRecommendationIntegrationResult({
            runtimeNextAction:
        ...
        expect(
          result.diagnostics.completedStages,
        ).toEqual([
          "runtime-next-action",
    ...
    it(
      "preserves a null Predictive Intelligence result",
      () => {
        const result =
          createRuntimeRecommendationIntegrationResult({
            runtimeNextAction:
    ...
    it(
      "returns insufficient-data when no source evidence exists",
      () => {
        const result =
          createRuntimeRecommendationIntegrationResult({
            runtimeNextAction:
        ...
        expect(
          result.diagnostics.completedStageCount,
        ).toBe(
          1,
        );
    ...
    it(
      "returns partial when Runtime Next Action is unavailable",
      () => {
        const result =
          createRuntimeRecommendationIntegrationResult({
            runtimeNextAction:
    ...
    it(
      "returns partial when Recommendation Comparison is unavailable",
      () => {
        const result =
          createRuntimeRecommendationIntegrationResult({
            runtimeNextAction:
    ...
    it(
      "returns partial when Observation Summary is unavailable",
      () => {
        const result =
          createRuntimeRecommendationIntegrationResult({
            runtimeNextAction:
    ...
    it(
      "returns executive-summary-partial when all sources exist but the Executive Summary is partial",
      () => {
        const result =
          createRuntimeRecommendationIntegrationResult({
            runtimeNextAction:
    ...
    it(
      "reports Base-only Recommendation availability",
      () => {
        const result =
          createRuntimeRecommendationIntegrationResult({
            runtimeNextAction:
    ...
    it(
      "reports Adaptive-only Recommendation availability",
      () => {
        const result =
          createRuntimeRecommendationIntegrationResult({
            runtimeNextAction:
    ...
    it(
      "combines, trims, and removes duplicate warnings",
      () => {
    ...
    it(
      "preserves the supplied generatedAt value",
      () => {
        const result =
          createRuntimeRecommendationIntegrationResult({
            runtimeNextAction:
    ...
    it(
      "returns defensively cloned nested result values",
      () => {
...
describe(
  "Integration Contract resolvers",
  () => {
    it(
      "defines the four active Integration stages",
      () => {
        expect(
          RUNTIME_RECOMMENDATION_INTEGRATION_STAGES,
        ).toEqual([
    ...
    it(
      "resolves availability from Integration source objects",
      () => {
        const availability =
          resolveRuntimeRecommendationIntegrationAvailability({
            runtimeNextActionAvailable:
    ...
    it(
      "resolves complete, partial, and insufficient-data statuses",
      () => {
    ...
    it(
      "resolves the earliest unavailable stage as the Integration reason",
      () => {
    ...
    it(
      "resolves completed stages in official stage order",
      () => {
        const stages =
          resolveRuntimeRecommendationIntegrationCompletedStages({
            runtimeNextActionAvailable:
    ...
    it(
      "normalizes warnings independently",
      () => {
        const executiveSummaryResult =
          createExecutiveSummaryResult({
            warnings: [
...
describe(
  "Integration clone helpers",
  () => {
    it(
      "clones the Executive Summary result independently",
      () => {
        const source =
          createExecutiveSummaryResult({
            warnings: [
        ...
        clone.policy.decimalPlaces =
          7;

        expect(
          source.executiveSummary.headline,
        ).not.toBe(
          "Modified headline",
        );
    ...
    it(
      "clones Integration diagnostics independently",
      () => {
        const source:
          RuntimeRecommendationIntegrationDiagnostics = {
            generatedAt:
    ...
    it(
      "clones the complete Integration result independently",
      () => {
        const source =
          createCompleteIntegrationResult();
        ...
        expect(
          clone.runtimeNextAction,
        ).not.toBe(
          source.runtimeNextAction,
        );

        expect(
          clone.recommendationComparison,
        ).not.toBe(
          source.recommendationComparison,
        );

        expect(
          clone.observationSummary,
        ).not.toBe(
          source.observationSummary,
        );

        expect(
          clone.executiveSummaryResult,
        ).not.toBe(
          source.executiveSummaryResult,
        );

        expect(
          clone.predictiveIntelligenceResult,
        ).toBeNull();
